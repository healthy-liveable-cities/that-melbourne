...
for (scen in c(scenarios_ShortTrips$scenario)) {
  for (n in 1:10) {
  
# X1 <- read_csv(paste0(local_dir_path, "results/scenarioTripsReplace/melbourne-outputs-raw/", scen, "/mmets/", n, ".csv"))
